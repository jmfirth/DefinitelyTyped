...
// Project: https://mikolalysenko.github.io/regl
    ...
    */
    ...
    declare namespace REGL {
        ...
        export interface Regl {
             ...
             */
            (state: REGL.State<Uniforms>): REGL.Command;
            ...
            framebuffer(context: PropType): REGL.Framebuffer;
             ...
             * the frame callback.
             */
            frame(callback: (context: Context) => void): REGL.Cancel;
        ...
        // export type UniformContextFunction = (context: Context, props: Object, batchId: number) => any;

        export type Uniforms = { [name: string]: DynamicVariableFn | Array<any> | DynamicVariable }

        interface State<U> {

            /* Shaders */
            context?: U; //  REGL.Props;
             ...
             */
            elements?: REGL.Elements | Array<any>; // TODO number[],
             ...
             */
            framebuffer?: (context: Context, props: Props, batchId: number) => REGL.Framebuffer | REGL.Framebuffer;
        ...
        */
        ...
        interface TextureCube extends Texture {
            ...
            subimage(face: REGL.TextureCubeFaceIndexType, data: TextureImageData, x?: number, y?: number, level?: number): Texture;
        }
